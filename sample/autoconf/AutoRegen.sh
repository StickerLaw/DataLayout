...
cwd=`pwd`
if test -d /home/zyuxuan/opt/llvm-source/autoconf/m4 ; then
  cd /home/zyuxuan/opt/llvm-source/autoconf/m4
  llvm_src_root=/home/zyuxuan/opt/llvm-source/
  llvm_obj_root=/home/zyuxuan/opt/llvm/
  cd $cwd
elif test -d /home/zyuxuan/opt/llvm/autoconf/m4 ; then
  cd /home/zyuxuan/opt/llvm/autoconf/m4
  llvm_src_root=/home/zyuxuan/opt/llvm-source/
  llvm_obj_root=/home/zyuxuan/opt/llvm/
  cd $cwd
else
